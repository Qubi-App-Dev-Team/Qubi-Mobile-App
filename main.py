...
from utils.firebase_rw import get_circuit_by_id, add_results, add_results_new, get_user_info
...
# send_circuit( run_request_id: str, user_id: str, circuit_id: str, circuit: dict[str, any], 
#               quantum_computer_type: str, shots: int):

send_circuit('123', 'YIcqRYGvenTVAMxpgwXPXA5rOyi2', '5x24CbCFtflbJHA8ldaD', '101', 'ionq', 100)
send_circuit('123', 'YIcqRYGvenTVAMxpgwXPXA5rOyi2', '5x24CbCFtflbJHA8ldaD', '101', 'ibm', 100)