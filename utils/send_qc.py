...
def get_circuit_results(circuit: QuantumCircuit, shots: int = 1000, quantum_computer_type: str = "ionq", backend_name: str = "ionq_simulator"):
    if quantum_computer_type == 'ionq':
        result = get_ionq_results(circuit, shots, backend_name = backend_name)
    elif quantum_computer_type == 'ibm':
        result = get_ibm_results(circuit, shots, backend_name = backend_name)
    else:
