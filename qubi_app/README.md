...
# Setup
## Files required for everything work during development. ALL SECRET. DO NOT COMMIT.
`qubi_app/lib/firebase_options.dart`  <-- generated by `flutterfire configure`  
`qubi_app/firebase.json`  <--- generated by `flutterfire configure`  
`qubi_app/.env`  <--- DIFFERS BETWEEN IOS & ANDROID! Make sure u have the right one
`backend/.env`
